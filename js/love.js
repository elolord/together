...
function showCountUpTimer() {
    ...
    const countupTimerText = document.getElementById("countup-timer-text");

    countupWrapper.style.display = "block";

    const startDate = new Date(2018, 0, 5, 0, 0, 0);
    ...
    function updateTimer() {
        ...
        countupTimerText.textContent = `${days} ngày, ${hours} giờ, ${minutes} phút, ${seconds} giây`;
    }
